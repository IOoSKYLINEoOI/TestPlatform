...
namespace TestPlatform.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260414200512_AddExam")]
            ...
            modelBuilder.Entity("TestPlatform.Core.Exams.Exam", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "PassingRule", "TestPlatform.Core.Exams.Exam.PassingRule#PassingRule", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Schedule", "TestPlatform.Core.Exams.Exam.Schedule#ExamSchedule", b1 =>
                        {
                            b1.IsRequired();
